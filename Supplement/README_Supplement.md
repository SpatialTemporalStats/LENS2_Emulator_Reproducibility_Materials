...
4. Calculate $v^2(L_i,l_j)$ under $Q_l=36$ and $Q_o=70$ and plot Figure S10(b) (The major computational time is to calculate the inverse SHT with $Q=36$ and $70$ for each $r$ and $t$. It will take about $0.8\times 7\times 86\times 12/3600=1.6$ hours without the parallel computation. We provide the intermediate result "v2hat.csv".)
